...
public class YggdrasilMinecraftSessionService
    ...
    private static final String BASE_URL = "http://localhost/kph";
    private static final URL JOIN_URL = HttpAuthenticationService.constantURL("http://localhost/kph/authorization.php?action=join");
    private static final URL CHECK_URL = HttpAuthenticationService.constantURL("http://localhost/kph/authorization.php?action=hasjoined");
    ...
    protected GameProfile fillGameProfile(GameProfile profile, boolean requireSecure) {
        try {
            ...
            url = HttpAuthenticationService.concatenateURL(url, "unsigned=true");
